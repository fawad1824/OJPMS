                                ...
                                <div id="collapsetwo" class="collapse show" aria-labelledby="headingtwo">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label ml-1 text-muted" for="customCheck3">101 To
                                                150</label>
                                        </div>

                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck4">
                                            <label class="custom-control-label ml-1 text-muted" for="customCheck4">151 To
                                                200</label>
                                        </div>

                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck5">
                                            <label class="custom-control-label ml-1 text-muted" for="customCheck5">201 To
                                                250</label>
                                        </div>

                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck6">
                                            <label class="custom-control-label ml-1 text-muted" for="customCheck6">251 To
                                                300</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>419 Lakeland Terrace
                                        Detroit, MI 48226</p>
                                    <ul class="employers-icons list-inline mb-1">
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>2984 Woodhill Avenue
                                        Easton, MD 21601</p>
                                    <ul class="employers-icons list-inline mb-1">
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                                        ...
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star-half"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>2683 Farland Street
                                        Chicago, IL 60631</p>
                                    <ul class="employers-icons list-inline mb-1">
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                                        ...
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star-outline"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>2120 County Line
                                        Road St George, FL 34683</p>
                                    <ul class="employers-icons list-inline mb-1">
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>3633 Cessna Drive
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>2797 Bartlett Avenue
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0">Web Delveloper</p>
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>2639 Warner Street
                                        Casper, WY 82601</p>
                                    <ul class="employers-icons list-inline mb-1">
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0">Graphic Designer</p>
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>4883 Patterson Road
                                        Brooklyn, NY 11230</p>
                                    <ul class="employers-icons list-inline mb-1">
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="employers-list position-relative pb-3 pt-3 pl-2 pr-2 border rounded">
                                ...
                                <div class="grid-list-desc text-center mt-3">
                                    ...
                                    <p class="text-muted mb-0">Web Delveloper</p>
                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>2424 Lowland Drive
                                        Chicago, IL 60606</p>
                                    <ul class="employers-icons list-inline mb-1">
                                        <li class="list-inline-item"><a href="#" class="text-success"><i
                                                    class="mdi mdi-star"></i></a></li>
